...
\cventry{\textsc{June-August 21}}{LFortran: Computational Chemistry}{Google Summer of Code}{}{Student}{Will complete the math intrinsic routines for the LFortran compiler and ensure computational chemistry projects can by compiled by interop with compiled gfortran modules}
