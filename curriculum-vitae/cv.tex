...
\cventry{\textsc{September 21\textsuperscript{st} 2019}}{OpenACC GPU Bootcamp}{Chemistry Department, IIT Kanpur}{Day long hands-on programming session covering basics as well as acceleration of Institute in-house code facilitated by a Senior Nvidia Solution Architect (Bharatkumar) and Prof. Debabrata Goswami as part of the OpenACC consortium}{}{}
\spacesection
