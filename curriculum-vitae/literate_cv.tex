...
\begin{itemize}
\item I worked on the implementation of an enhanced version of the CHILL (CHILL+) algorithm for tracking ice types
...
\label{sec:orge0bff7b}
\subsection{Memberships}
\label{sec:orga7cf584}
...
\label{sec:org4a859a2}
\subsection{Personal}
\label{sec:org2ceddf2}
...
\label{sec:orgb362b76}
\subsection{Posters}
\label{sec:org6d8ef17}
...
\label{sec:org6d19c66}
\subsection{Coursera}
\label{sec:org66fe13d}
...
\label{sec:org5947758}
\subsection{Internships}
\label{sec:orgc46d53a}
