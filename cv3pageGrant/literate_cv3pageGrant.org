...
\section{Selected Publications and Method Outputs}
...
\compactentry{Doctoral-student training relevance}{IRF proposal}{Can train a doctoral student across rare-event theory, saddle search, MLIP validation, GP uncertainty, kinetic-network analysis, and reproducible scientific computing.}
...
\skillline{Scientific domains}{Chemical kinetics, transition-state theory, adaptive kinetic Monte Carlo, molecular dynamics, photocatalysis, atomistic machine learning, Bayesian optimization, Gaussian processes, uncertainty quantification.}
